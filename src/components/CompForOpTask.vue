<template>
  <div
    ...
    style="border: 1px solid black; width: 850px; padding: 10px; margin:10px 0 10px 10px"
  >
    <div
      class="row"
    >
    ...
    >
      <div
        class="text-h6 vertical-top" style="width:250px; display:flex; align-items: center;"
      >
    ...
    >
      ...
      <div>
        <q-input
          ...
          square
          outlined
          v-model="commentaryAboutDeclined"
          label="Комментарий преподавателя"
          v-show="!(isAccepted==='declined')"
          class="q-pt-sm"
          style="width:380px"
        />
      </div>
      <div
        v-show="!(isAccepted==='accepted')"
      >
        <div>
          <div
      ...
      <div
        class="q-pt-sm row q-gutter-x-md"
      >
        <q-btn
          :disable="submitted"
          label="Submit"
          ...
          type="submit"
          style="width:100px"
          v-show="!((isAccepted==='noChoose') || (isAccepted==='accepted') && (problemDifficult === ''))"
        />
        <q-btn
          label="Edit"
          color="blue"
