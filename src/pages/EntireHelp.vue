...
>
  ...
  В это случае, даже если сейчас идет интервал решения, задача будет скрыта от пользователей.
  ...
  <br/>На странице задачи есть таблица всех учеников (пользователей, которые добавили на эту задачу хотя бы одну попытку).
  ...
  <br/>Для просмотра или загрузки на компьютер попытки ученика или отзыва учителя можно воспользоваться аналогичными кнопками.
